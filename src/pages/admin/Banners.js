...
<section class="bg-white dark:bg-gray-900">
    <div class="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
        <div class="mr-auto place-self-center lg:col-span-7">
            ...
            <a href="/admin/addguestbanner" style={{background:'green',color:"white"}} class="inline-flex items-center justify-center px-5 py-3 mr-3 text-base font-medium text-center text-black rounded-lg bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:focus:ring-primary-900">
                Addbanner
        ...
        <div class="lg:mt-0 lg:col-span-5 lg:flex rounded-lg">
            {/* <img src="https://res.cloudinary.com/dft5pexxb/image/upload/v1691580638/rbdeej2jzbnr89m6clcd.jpg" alt="mockup"/> */}
        </div>                
    </div>
</section>
