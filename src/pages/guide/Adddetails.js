  ...
  const getLocation=async()=>{
    ...
    try {
      dispatch(showloading())
       const response=await axios.post('http://globalone.shop/api/guide/getlocations')
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      dispatch(showloading())
        ...
        const response = await axios.post('http://globalone.shop/api/guide/addDetails', formData, {
          headers: {
